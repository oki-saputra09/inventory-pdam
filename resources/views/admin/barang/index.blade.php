...
<head>
    ...
    <title>Data Barang - INVENDAM</title>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <h3>DATA BARANG</h3>
                    <p>Kelola data barang inventory</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Data Barang</h4>
                <p>Halaman ini digunakan untuk mengelola data barang.</p>
            </div>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        <form action="{{ route('admin.barang.index') }}" method="GET" class="search-form">
                            ...
                            @if(!empty($search))
                                <a href="{{ route('admin.barang.index') }}" class="btn-reset">
                                    Reset
                                </a>
                            @endif
                        </form>
                    ...
                    <div class="col-md-4 text-md-end">
                        <a href="{{ route('admin.barang.create') }}" class="btn-primary-soft">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($item->stok == $item->minimum_stok)
                                            <span class="badge-status badge-warning-soft">Minimum</span>
                                        @else
                                            <span class="badge-status badge-danger-soft">Hampir Habis</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.barang.edit', $item->id) }}" class="btn-action btn-edit">
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        @if(!empty($search))
                                            Data barang tidak ditemukan untuk pencarian "{{ $search }}"
                                        @else
