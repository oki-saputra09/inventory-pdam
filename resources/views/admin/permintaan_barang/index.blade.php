...
<head>
    ...
    <title>Permintaan Barang - INVENDAM</title>
...
<div class="layout">
    <aside class="sidebar" id="sidebarMenu">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="{{ route('admin.permintaan-barang.index') }}" class="active">
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    ...
                    <p>Kelola persetujuan permintaan barang dari staf</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                ...
                <p>Admin dapat menyetujui, menolak, atau menghapus permintaan barang dari staf.</p>
            </div>
            ...
            <div class="card-soft table-card">
                <div class="result-info" id="resultInfo">
                    Gunakan pencarian untuk menemukan permintaan barang dengan cepat.
                </div>
                            ...
                            @forelse ($permintaanBarang as $item)
                                ...
                                >
                                    ...
                                    <td class="text-center">
                                        @if ($item->status === 'Menunggu')
                                            <form action="{{ route('admin.permintaan-barang.setuju', $item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('PUT')

                                                <button type="submit" class="btn-action btn-setuju" onclick="return confirm('Setujui permintaan ini?')">
                                                    <i class="bi bi-check-circle"></i>
                                                    Setuju
                                                </button>
                                            </form>

                                            <form action="{{ route('admin.permintaan-barang.tolak', $item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('PUT')

                                                <button type="submit" class="btn-action btn-tolak" onclick="return confirm('Tolak permintaan ini?')">
                                                    <i class="bi bi-x-circle"></i>
                                                    Tolak
                                                </button>
                                            </form>
                                        ...
                                        <form action="{{ route('admin.permintaan-barang.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')

                                            <button type="submit" class="btn-action btn-delete" onclick="return confirm('Hapus data permintaan ini?')">
                                ...
                                <tr>
                                    <td colspan="9">
                                        <div class="empty-state">
                                            ...
                                            <p class="mb-0">
                                                Permintaan barang dari staf akan muncul di halaman ini.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tr class="empty-search-row" id="emptySearchRow">
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p class="mb-0">
                                            Tidak ada permintaan barang yang sesuai dengan pencarian.
                                        </p>
                                    </div>
                                </td>
                            </tr>
                ...
                @if(method_exists($permintaanBarang, 'links'))
                    <div class="pagination-wrapper">
                        {{ $permintaanBarang->withQueryString()->links() }}
                    </div>
                @endif
            </div>
        </div>
    ...
    function filterPermintaan() {
        ...
        if (resultInfo) {
            if (keyword || status) {
                ...
                resultInfo.innerHTML = 'Gunakan pencarian untuk menemukan permintaan barang dengan cepat.';
            }
        }
    }

    if (searchInput) {
        searchInput.addEventListener('keyup', filterPermintaan);
    }

    if (statusFilter) {
        statusFilter.addEventListener('change', filterPermintaan);
    }

    if (searchButton) {
        searchButton.addEventListener('click', filterPermintaan);
    }
