...
<head>
    <meta charset="UTF-8">
    <title>Notifikasi Stok - INVENDAM</title>
...
<div class="layout">
    <aside class="sidebar" id="sidebarMenu">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="{{ route('admin.notifikasi-stok.index') }}" class="active">
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    ...
                    <p>Monitoring barang yang mencapai minimum stok</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Notifikasi Stok Barang</h4>
                <p>Daftar barang dengan stok kurang dari atau sama dengan minimum stok.</p>
            </div>

            @if ($totalNotifikasi > 0)
                <div class="alert-soft-warning">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i>
                    Ada {{ $totalNotifikasi }} barang dengan stok minimum atau stok rendah.
                </div>
            @else
                ...
                <div class="search-form">
                    <div class="search-box">
                        ...
                        <input
                            ...
                            id="searchInput"
                            class="search-input"
                            placeholder="Cari kode barang / nama barang / kategori / satuan..."
                        >
                    </div>
            ...
            <div class="card-soft table-card">
                <div class="result-info" id="resultInfo">
                    Gunakan pencarian untuk menemukan notifikasi stok dengan cepat.
                </div>
                    ...
                    <table class="table table-custom table-hover align-middle mb-0">
                        ...
                        <tbody id="stokTableBody">
                            @forelse ($barang as $item)
                                @php
                                    $status = $item->stok < $item->minimum_stok ? 'rendah' : 'minimum';
                                ...
                                <tr class="stok-row" data-search="{{ $searchText }}">
                                    ...
                                    <td>
                                        ...
                                        <div class="text-sub">Barang stok perlu dipantau</div>
                                    </td>
                                    ...
                                    <td>
                                        @if($item->stok < $item->minimum_stok)
                                            <span class="badge-status status-rendah">
                                                <i class="bi bi-x-circle"></i>
                                                Stok Rendah
                                            </span>
                                        @else
                                            <span class="badge-status status-minimum">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="empty-state">
                                            ...
                                            <h5>Stok Aman</h5>
                                            <p class="mb-0">
                                                Tidak ada barang dengan stok minimum atau stok rendah.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tr class="empty-search-row" id="emptySearchRow">
                                <td colspan="8">
                                    <div class="empty-state">
                                        ...
                                        <p class="mb-0">
                                            Tidak ada notifikasi stok yang sesuai dengan pencarian.
                                        </p>
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    function filterStok() {
        ...
        if (emptySearchRow) {
            emptySearchRow.style.display = visibleCount === 0 && stokRows.length > 0 ? 'table-row' : 'none';
        }
        ...
        if (resultInfo) {
            if (keyword) {
                ...
                resultInfo.innerHTML = 'Gunakan pencarian untuk menemukan notifikasi stok dengan cepat.';
            }
        }
    }

    if (searchInput) {
        searchInput.addEventListener('keyup', filterStok);
    }

    if (searchButton) {
        searchButton.addEventListener('click', filterStok);
    }
