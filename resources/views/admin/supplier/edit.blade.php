...
<head>
    ...
    <title>Edit Supplier - INVENDAM</title>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <h3>EDIT SUPPLIER</h3>
                    <p>Perbarui data supplier inventory PDAM</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Edit Supplier</h4>
                <p>Perbarui data supplier dengan benar.</p>
            </div>

            <div class="card-soft form-card">
                <form action="{{ route('admin.supplier.update', $supplier->id) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
