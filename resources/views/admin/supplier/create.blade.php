...
<head>
    ...
    <title>Tambah Supplier - INVENDAM</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .layout { width: 100%; height: 100vh; display: flex; }
...
<body>
    @php $logoKantor = asset('images/logo.png'); @endphp
    ...
    <div class="layout">
        <aside class="sidebar" id="sidebarMenu">
            ...
            <ul class="menu">
                ...
                <li><a href="{{ route('admin.supplier.index') }}" class="active"><i class="bi bi-truck"></i> Supplier</a></li>
            </ul>
        </aside>
        ...
        <main class="main">
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <p>Masukkan data supplier dengan lengkap dan benar.</p>
                </div>
                ...
                <div class="card-soft form-card">
                    <form action="{{ route('admin.supplier.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <a href="{{ route('admin.supplier.index') }}" class="btn-light-soft">
