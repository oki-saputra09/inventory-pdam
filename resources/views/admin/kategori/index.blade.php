...
<head>
    ...
    <title>Data Kategori - INVENDAM</title>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <h3>DATA KATEGORI</h3>
                    <p>Kelola kategori barang inventory</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Data Kategori</h4>
                <p>Halaman ini digunakan untuk mengelola kategori barang.</p>
            </div>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        <form action="{{ route('admin.kategori.index') }}" method="GET" class="search-form">
                            ...
                            @if(!empty($search))
                                <a href="{{ route('admin.kategori.index') }}" class="btn-reset">
                                    Reset
                                </a>
                            @endif
                        </form>
                    ...
                    <div class="col-md-4 text-md-end">
                        <a href="{{ route('admin.kategori.create') }}" class="btn-primary-soft">
                        ...
                        <tbody>
                            @forelse ($kategori as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.kategori.edit', $item->id) }}" class="btn-action btn-edit">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center py-4">
                                        @if(!empty($search))
                                            Data kategori tidak ditemukan untuk pencarian "{{ $search }}"
                                        @else
