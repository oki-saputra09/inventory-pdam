...
<head>
    ...
    <title>Edit Kategori - INVENDAM</title>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <h3>EDIT KATEGORI</h3>
                    <p>Perbarui data kategori barang inventory PDAM</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Edit Kategori</h4>
                <p>Perbarui nama kategori dan deskripsi dengan benar.</p>
            </div>

            <div class="card-soft form-card">
                <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
