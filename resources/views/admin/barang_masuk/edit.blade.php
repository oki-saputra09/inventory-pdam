...
<head>
    ...
    <title>Edit Barang Masuk - INVENDAM</title>
        ...
        <main class="main">
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        ...
                        <p>Ubah transaksi barang masuk</p>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <p>Perbarui data barang masuk dengan benar.</p>
                </div>
                    ...
                    <form action="{{ route('admin.barang-masuk.update', $barangMasuk->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="supplier_id" id="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror">
                                    ...
                                    @foreach ($supplier as $item)
                                        <option value="{{ $item->id }}" {{ old('supplier_id', $barangMasuk->supplier_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_supplier }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_masuk" id="tanggal_masuk" class="form-control @error('tanggal_masuk') is-invalid @enderror" value="{{ old('tanggal_masuk', $barangMasuk->tanggal_masuk) }}">
                                @error('tanggal_masuk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="jumlah" id="jumlah" class="form-control @error('jumlah') is-invalid @enderror" value="{{ old('jumlah', $barangMasuk->jumlah) }}" min="1">
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="keterangan" id="keterangan" rows="4" class="form-control @error('keterangan') is-invalid @enderror">{{ old('keterangan', $barangMasuk->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
