...
<head>
    ...
    <title>Edit Barang Keluar - INVENDAM</title>
        ...
        <main class="main">
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        ...
                        <p>Ubah transaksi barang keluar</p>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <p>Perbarui data barang keluar dengan benar.</p>
                </div>
                ...
                <div class="card-soft form-card">
                    <form action="{{ route('admin.barang-keluar.update', $barangKeluar->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <select name="barang_id" id="barang_id" class="form-select @error('barang_id') is-invalid @enderror">
                                    ...
                                    @foreach ($barang as $item)
                                        <option value="{{ $item->id }}" {{ old('barang_id', $barangKeluar->barang_id) == $item->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Bagian Teknik"
                                >
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <a href="{{ route('admin.barang-keluar.index') }}" class="btn-light-soft">
