...
<head>
    <meta charset="UTF-8">
    <title>Edit Akun Staf - INVENDAM</title>
    ...
    <main class="main">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <h3>EDIT AKUN STAF</h3>
                    <p>Perbarui data akun staf</p>
                </div>
            </div>
        ...
        <div class="content">
            <div class="page-header">
                <h4>Edit Akun Staf</h4>
                <p>Ubah status menjadi nonaktif agar staf tidak bisa login.</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.user.update', $user->id) }}" autocomplete="off">
                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_hp" value="{{ old('no_hp', $user->no_hp) }}" class="form-control-custom">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ optional($user->role)->name ?? 'Staf' }}" class="form-control-custom" readonly>
                        </div>
