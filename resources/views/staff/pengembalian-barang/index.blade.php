...
<head>
    <meta charset="UTF-8">
    <title>Pengembalian Barang - Staf</title>
...
<div class="staff-wrapper">
    <div class="topbar">
        <div>
            ...
            <p>Kelola pengembalian barang yang kamu ajukan.</p>
        </div>
    ...
    <div class="page-card">
        <div class="page-header">
            <div>
                ...
                <p>Status pengembalian akan berubah setelah diproses oleh admin.</p>
            </div>
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <a href="{{ route('staff.pengembalian-barang.create') }}" class="btn-main">
                ...
                <tbody>
                    @forelse($pengembalianBarang as $item)
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->foto_bukti)
                                    <a href="{{ asset($item->foto_bukti) }}" target="_blank">
                            ...
                            <td>
                                @if($status === 'menunggu')
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('staff.pengembalian-barang.edit', $item->id) }}" class="btn-edit">
                                            <i class="bi bi-pencil-square"></i>
                                            Edit
                                        </a>

                                        <form action="{{ route('staff.pengembalian-barang.destroy', $item->id) }}"
                                              method="POST"
                        ...
                        <tr>
                            <td colspan="8">
                                <div class="empty-state">
                                    ...
                                    <p>Klik tombol Ajukan Pengembalian untuk membuat pengembalian barang baru.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
