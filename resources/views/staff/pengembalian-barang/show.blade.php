...
<head>
    ...
    <title>Detail Pengembalian - INVENDAM</title>
...
<div class="page-wrap">
    ...
    <div class="topbar">
        ...
        <a href="{{ route('staff.pengembalian-barang.index') }}" class="btn-back">
        ...
        <div class="detail-body">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value" style="flex: 1;">
                    ...
                    @else
                        <span style="color: var(--muted);">Belum ada foto bukti.</span>
                    @endif
                </div>
            </div>
        </div>
