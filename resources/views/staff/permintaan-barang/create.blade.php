...
<head>
    <meta charset="UTF-8">
    <title>Ajukan Permintaan Barang - Staf</title>
...
<div class="staff-wrapper">
    <div class="topbar">
        <div>
            ...
            <p>Cari barang terlebih dahulu, lalu isi detail permintaan.</p>
        </div>
    ...
    <div class="page-card">
        <div class="page-header">
            ...
            <p>
                ...
                Permintaan akan berstatus <strong>Menunggu</strong> sampai diproses admin.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('staff.permintaan-barang.store') }}" autocomplete="off" id="permintaanForm" class="request-form">
            @csrf
            ...
            <div class="request-layout">
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <p>Lengkapi tanggal, jumlah, dan keterangan permintaan.</p>
                    </div>

                    <div class="panel-body">
                        <div class="summary-box">
                            <h6>Status Permintaan</h6>
                            <p>Permintaan baru otomatis masuk sebagai Menunggu.</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                placeholder="Contoh: Untuk kebutuhan operasional lapangan..."
...
<script>
    ...
    if (permintaanForm) {
        permintaanForm.addEventListener('submit', function (event) {
