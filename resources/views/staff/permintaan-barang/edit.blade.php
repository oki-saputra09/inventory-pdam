...
<head>
    <meta charset="UTF-8">
    <title>Edit Permintaan Barang - Staf</title>
...
<div class="staff-wrapper">
    <div class="topbar">
        <div>
            ...
            <p>Ubah permintaan barang yang masih berstatus menunggu.</p>
        </div>
    ...
    <div class="page-card">
        <div class="page-header">
            <div>
                ...
                <p>Permintaan hanya bisa diubah selama status masih <strong>Menunggu</strong>.</p>
            </div>

            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('staff.permintaan-barang.index') }}" class="btn-secondary-custom">
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('staff.permintaan-barang.update', $permintaanBarang->id) }}" autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                        ...
                        <select name="barang_id" class="form-select-custom" required>
                            ...
                            @foreach($barang as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('barang_id', $permintaanBarang->barang_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama_barang }}
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('tanggal_permintaan', \Carbon\Carbon::parse($permintaanBarang->tanggal_permintaan)->format('Y-m-d')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="number"
                            name="jumlah"
                            value="{{ old('jumlah', $permintaanBarang->jumlah) }}"
                            class="form-control-custom"
                            min="1"
                            required
                        >
                    ...
                    <div class="form-group full">
                        ...
                        >{{ old('keterangan', $permintaanBarang->keterangan) }}</textarea>
                ...
                <div class="info-box">
                    ...
                    <div>
                        Setelah admin memproses permintaan menjadi <strong>Disetujui</strong> atau <strong>Ditolak</strong>,
                        permintaan tidak bisa diedit atau dihapus lagi.
                    </div>
                </div>
